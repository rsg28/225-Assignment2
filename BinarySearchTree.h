...
public:
    ...
    /**
     * With debugging purposes, addresses, keys and a tree representation is printed all together
     */
    void displayLinks(ostream &out = cout) const
    {
        out << "Start of BSTtest" << endl;
        out << "Keys:";
        printTree(out);
        out << "Tree:" << endl;
        displayTree(out);
...
private:
    ...
    *****************************************************/
    ...
    /**
     * Internal method to print a subtree rooted at t in sorted order with addresses.
     */
